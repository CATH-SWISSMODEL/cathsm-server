...
const rows = [
  ...
  { id: 'description', numeric: true, disablePadding: false, label: 'FunFam Description' },
  { id: 'query_region', numeric: true, disablePadding: false, label: 'Query Location' },
  { id: 'match_region', numeric: true, disablePadding: false, label: 'Match Location' },
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell numeric>{n.query_region}</TableCell>
                      <TableCell numeric>{n.match_region}</TableCell>
